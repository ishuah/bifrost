...
func TestPollKeyEvents(t *testing.T) {
	testKeys := TestKeyMap{
		...
		CtrlD:      TestKey{keybd_event.VK_D, true},
		CtrlE:      TestKey{keybd_event.VK_E, true},
		CtrlF:      TestKey{keybd_event.VK_F, true},
		CtrlK:      TestKey{keybd_event.VK_K, true},
		CtrlU:      TestKey{keybd_event.VK_U, true},
